 ...
 *//**
	 ...
	 *//*
		 ...
		 * 
		 * @ResponseBody public Map<String, Object> exceptionHandler(HttpServletRequest
		 * req, Exception e) throws Exception { Map<String, Object> modelMap = new
		 * HashMap<String, Object>(); modelMap.put("success", false);
